...
Index of this project's memory. Read this and `CLAUDE.md` at the start of a
session. Kept short on purpose — the full narrative decision log lives in
dated files under `memory/`, not here, so this file doesn't grow without
bound (see `memory/2026-08.md` §9 for why).
...
- [`CLAUDE.md`](CLAUDE.md) — current-state handoff: what exists, what's
  unverified, known traps.
- [`TASKS.md`](TASKS.md) — open items.
