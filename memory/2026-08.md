...
to implement. Would need its own port, separate from `StudioPro-MCU`
(continuous realtime message stream, not a request/response protocol like
MCU control messages).
