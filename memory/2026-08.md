...
**Not yet done on this machine** (code-only rename, doesn't touch the
running environment): the loopMIDI port and the DAW's External Devices
Mackie Control binding still say `StudioOneMCP` — tracked in `TASKS.md`.
